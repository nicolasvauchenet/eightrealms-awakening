 ...
 */
final class Version20241219132828 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE potion (id INT NOT NULL, target VARCHAR(255) DEFAULT NULL, amount INT DEFAULT NULL, duration INT DEFAULT NULL, PRIMARY KEY(id))');
