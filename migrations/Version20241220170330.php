...
final class Version20241220170330 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE action (id SERIAL NOT NULL, label VARCHAR(255) NOT NULL, picture VARCHAR(255) DEFAULT NULL, action_effects JSON DEFAULT NULL, scene_id INT NOT NULL, target_scene_id INT DEFAULT NULL, target_screen_id INT DEFAULT NULL, type VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
