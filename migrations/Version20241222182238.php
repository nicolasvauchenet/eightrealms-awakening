...
final class Version20241222182238 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE quest_step (id SERIAL NOT NULL, quest_id INT NOT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, picture VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, position INT NOT NULL, crown_reward INT DEFAULT NULL, PRIMARY KEY(id))');
