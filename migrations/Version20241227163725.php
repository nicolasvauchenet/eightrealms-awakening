...
final class Version20241227163725 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE player_creature (id SERIAL NOT NULL, health INT NOT NULL, mana INT NOT NULL, player_id INT NOT NULL, creature_id INT NOT NULL, scene_id INT NOT NULL, crown_reward INT DEFAULT NULL, xp_reward INT DEFAULT NULL, alive BOOLEAN NOT NULL, PRIMARY KEY(id))');
