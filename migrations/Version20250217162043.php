 ...
 */
final class Version20250217162043 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE character (id SERIAL NOT NULL, race_id INT NOT NULL, profession_id INT NOT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, picture VARCHAR(255) DEFAULT NULL, description TEXT DEFAULT NULL, strength INT NOT NULL, dexterity INT NOT NULL, constitution INT NOT NULL, wisdom INT NOT NULL, intelligence INT NOT NULL, charisma INT NOT NULL, health_max INT NOT NULL, health INT NOT NULL, mana_max INT NOT NULL, mana INT NOT NULL, fortune INT NOT NULL, type VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
