...
final class Version20250218141423 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE character_item (id SERIAL NOT NULL, character_id INT NOT NULL, item_id INT NOT NULL, equipped BOOLEAN NOT NULL, health INT DEFAULT NULL, charge INT DEFAULT NULL, slot VARCHAR(255) DEFAULT NULL, quest_item BOOLEAN NOT NULL, PRIMARY KEY(id))');
