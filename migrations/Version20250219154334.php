...
final class Version20250219154334 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE spell ADD CONSTRAINT FK_D03FCD8D12469DE2 FOREIGN KEY (category_id) REFERENCES "category_spell" (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    }
