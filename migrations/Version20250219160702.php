 ...
 */
final class Version20250219160702 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE character_spell (id SERIAL NOT NULL, character_id INT NOT NULL, spell_id INT NOT NULL, level INT NOT NULL, mana INT NOT NULL, amount INT NOT NULL, area INT NOT NULL, duration INT NOT NULL, PRIMARY KEY(id))');
