...
final class Version20250419231219 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE player_npc_item (id SERIAL NOT NULL, player_npc_id INT NOT NULL, item_id INT NOT NULL, original BOOLEAN NOT NULL, health INT DEFAULT NULL, charge INT DEFAULT NULL, PRIMARY KEY(id))
        SQL);
        $this->addSql(<<<'SQL'
