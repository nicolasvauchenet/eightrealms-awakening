...
final class Version20250423183846 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql(<<<'SQL'
            CREATE TABLE combat (id SERIAL NOT NULL, reward_id INT DEFAULT NULL, location_id INT NOT NULL, quest_step_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, slug VARCHAR(255) NOT NULL, picture VARCHAR(255) NOT NULL, thumbnail VARCHAR(255) NOT NULL, description TEXT NOT NULL, conditions JSON DEFAULT NULL, victory_description TEXT NOT NULL, defeat_description TEXT NOT NULL, redirect_to_interaction VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id))
        SQL);
        $this->addSql(<<<'SQL'
