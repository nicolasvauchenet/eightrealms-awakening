...
{
    const CAMPEMENT_GOBELIN_COMBATS = [
        // Quêtes
        [
            ...
            'defeatDescription' => "<p>Les gobelins étaient trop forts, trop rapides, ou simplement trop déterminés. Le Chef Gobelin sourit en posant un pied crasseux sur votre corps. L’aventurier s’effondre, la mission interrompue brutalement. Le campement reste aux mains de ses hôtes peu diplomates, et le village restera la cible de ces pilleurs sans vergogne.</p><p>À moins que vous ne vous releviez. Relevez-vous, remerciez le Grand-Prêtre, et préparez-vous&nbsp;! Plouc a besoin de vous&nbsp;!</p>",
        ...
        [
            ...
            'victoryDescription' => "<p>Les éclaireurs sont neutralisés. Le silence revient sur la zone, laissant supposer que cette patrouille ne signalera rien à personne. Un répit bienvenu dans cette forêt toujours en alerte.</p><p>Vous pouvez continuer votre chemin vers le campement…</p>",
            'defeatDescription' => "<p>Les gobelins ont parfaitement rempli leur mission&nbsp;:&nbsp;repousser les intrus. Leur attaque coordonnée laisse l’adversaire à terre, désarmé, contraint à la retraite. Ce sentier restera leur territoire… pour le moment.</p>",
            'location' => 'location_screen_encounter_foret',
            'enemies' => [
                [
