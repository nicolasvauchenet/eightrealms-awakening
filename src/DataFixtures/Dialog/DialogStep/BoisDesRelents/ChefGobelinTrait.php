...
trait ChefGobelinTrait
{
    const CHEF_GOBELIN_DIALOG_STEPS = [
        ...
        [
            ...
            'dialog' => 'quest_secondary_chef_gobelin',
            'reference' => 'quest_secondary_chef_gobelin_1',
        ],
        [
            ...
            'dialog' => 'quest_secondary_chef_gobelin',
            'reference' => 'quest_secondary_chef_gobelin_2',
        ],
        [
            ...
            'dialog' => 'quest_secondary_chef_gobelin',
            'reference' => 'quest_secondary_chef_gobelin_3',
        ],
        [
            ...
            'dialog' => 'quest_secondary_chef_gobelin',
            'reference' => 'quest_secondary_chef_gobelin_4',
        ],
        [
        ...
        [
            ...
            'dialog' => 'quest_secondary_chef_gobelin',
            'reference' => 'quest_secondary_chef_gobelin_6',
        ],
        ...
        [
            ...
            'reference' => 'dialog_chef_gobelin_1',
        ],
    ];
}
