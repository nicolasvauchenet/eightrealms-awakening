...
trait GrandDruideTrait
{
    const GRAND_DRUIDE_DIALOG_STEPS = [
        ...
        [
            ...
            'text' => "<p><em>Tu as traversé l’épreuve sans perdre ton essence.</em></p><p>Il vous regarde un long moment sans rien dire, comme s'il lisait quelque chose dans vos yeux.</p><p><em>Le Rituel de l’Âme permet de pénétrer dans le Donjon de l’Âme. Le Médaillon des Vents n’est qu’un fragment. Un éclat du Sceau du Tombeau… Celui où repose Galdric, le Premier du nom.</em></p><p><em>Son tombeau se trouve tout au fond du Donjon. Mais prends garde… le Donjon de l'Âme est un lieu maudit, où les épreuves se succèdent jusqu'à venir à bout des plus valeureux.</em></p>",
            'first' => true,
            'conditions' => [
                'quest_step_status' => [
                    'quest' => 'les-disparus-du-donjon',
        ...
        [
            'name' => 'Grand Druide - Rituel',
            'text' => "<p><em>Des noms, il en eut cent. Mais aujourd’hui… aucun ne devrait être prononcé. Pars maintenant. Accomplis le destin, ou meurs en essayant.</em></p>",
            'conditions' => [
                'quest_step_status' => [
                    'quest' => 'les-disparus-du-donjon',
                    'quest_step' => 10,
