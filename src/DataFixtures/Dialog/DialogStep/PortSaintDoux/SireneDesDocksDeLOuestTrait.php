...
trait SireneDesDocksDeLOuestTrait
{
    const SIRENE_DES_DOCKS_DE_L_OUEST_DIALOG_STEPS = [
        ...
        [
            'name' => "Sirène des Docks de l'Ouest - Combat",
            ...
            'dialog' => 'quest_secondary_sirene_des_docks_de_louest',
            'reference' => 'quest_secondary_sirene_des_docks_de_louest_1',
        ],
        [
            'name' => "Sirène des Docks de l'Ouest - Après le combat",
            'text' => "<p>La Sirène, blessée, vous observe sans colère. Sa voix, lorsqu’elle s’élève, semble flotter au bord du silence.</p><p><em>Le serment fut brisé sous une lune sans reflet. Il a laissé derrière lui un éclat… un souvenir oublié sur une plage où le vent chante encore son nom.</em></p><p>Ses yeux se voilent un instant.</p><p><em>Va vers les dunes dorées. Là où les sables brûlent les cœurs et les promesses. Cherche la Plage de la Sirène. L’objet y attend…</em></p><p>Elle plonge alors sans un bruit, ne laissant derrière elle qu’un frisson sur les vagues.</p>",
            'first' => true,
            'conditions' => [
                'quest_step_status' => [
                    'quest' => 'la-sirene-et-le-marin',
            ...
            'dialog' => 'quest_secondary_sirene_des_docks_de_louest',
            'reference' => 'quest_secondary_sirene_des_docks_de_louest_2',
        ],
        [
            'name' => "Sirène des Docks de l'Ouest - Retour",
            ...
            'dialog' => 'quest_secondary_sirene_des_docks_de_louest',
            'reference' => 'quest_secondary_sirene_des_docks_de_louest_3',
        ],
        [
            'name' => "Sirène des Docks de l'Ouest - Quête terminée - Vérité",
            ...
            'dialog' => 'quest_secondary_sirene_des_docks_de_louest',
            'reference' => 'quest_secondary_sirene_des_docks_de_louest_4',
        ],
        [
            'name' => "Sirène des Docks de l'Ouest - Quête terminée - Mensonge",
            ...
            'dialog' => 'quest_secondary_sirene_des_docks_de_louest',
            'reference' => 'quest_secondary_sirene_des_docks_de_louest_5',
        ],
    ];
}
