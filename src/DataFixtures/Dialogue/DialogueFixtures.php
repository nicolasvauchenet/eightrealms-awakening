    ...
    public function load(ObjectManager $manager): void
    {
        $dialogues = [
            ...
            [
                ...
                'reference' => 'dialogue_robert_le_garde_rumor_accept',
            ],
            [
                'type' => 'rumor',
                ...
                'npc' => 'npc_robert_le_garde',
                'parent' => 'dialogue_robert_le_garde_rumor_2',
                'reference' => 'dialogue_robert_le_garde_rumor_decline',
            ],
            ...
            [
                ...
                'reference' => 'dialogue_bilo_le_passant_rumor_accept',
            ],
            [
                'type' => 'rumor',
                ...
                'npc' => 'npc_bilo_le_passant',
                'parent' => 'dialogue_bilo_le_passant_rumor_2',
                'reference' => 'dialogue_bilo_le_passant_rumor_decline',
            ],
        ];
