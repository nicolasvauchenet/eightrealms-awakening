...
trait RealmTrait
{
    const REALM_LOCATION = [
        [
            ...
            'description' => "<p>L'Île du Nord est un royaume prospère, dirigé par le roi Galdric III. Les terres fertiles et les mines d'or font la richesse de ce petit royaume, qui attire commerçants et aventuriers en quête de fortune. Les habitants, fiers de leur patrie, sont réputés pour leur hospitalité et leur sens de l'honneur.</p>",
            'type' => 'realm',
