...
trait MainQuestStepTrait
{
    const MAIN_QUEST_STEPS = [
        ...
        [
            'description' => "<p>Avant de quitter le campement gobelin dans les Bois des Relents, leur chef m’a glissé une information troublante. Un vieil homme est passé non loin, seul, l’air pressé, marmonnant que &laquo;&nbsp;son fils allait faire une erreur monumentale&nbsp;&raquo; et qu’il &laquo;&nbsp;devait l’arrêter coûte que coûte.&nbsp;&raquo; Ils l’ont vu s’engager vers le Col du Vent Noir, en direction des Monts Terribles.</p><p>Impossible de ne pas faire le lien avec ce que j’ai appris… Le Roi Galdric III serait-il lui aussi parti vers le nord&nbsp;? Et dans ce cas, pourquoi passer par les Monts Terribles, au lieu de les contourner&nbsp;?</p>",
            'position' => 4,
            'last' => false,
            'quest' => 'quest_main',
        ...
        [
            'description' => "<p>Je suis revenu au Bois du Pendu, attiré par des rumeurs et des courants d’air chargés de regrets. Là, dans un recoin oublié d'une crique un peu glauque, j’ai trouvé un esprit suspendu à la mémoire des vivants&nbsp;:&nbsp;Gérôme. Il n’était plus de ce monde, mais son châtiment le retenait ici, dans l’ombre des branches. Un druide ancien, condamné pour avoir osé défier les règles du Cercle et remettre en question le secret du Rituel de l’Âme. Pour cela, il avait été pendu. Et oublié.</p><p>Mais son âme n’avait pas fui. En répondant à ses questions, en retrouvant son histoire, je l’ai aidé à rassembler les fragments de sa mémoire dispersée. Lorsqu’il s’est souvenu de qui il était, la corde a disparu. Il a retrouvé la paix. Avant de s’effacer, il m’a laissé l’Amulette du Cercle, une relique oubliée, symbole de sa sagesse bannie et de son appartenance à l'Ancien Cercle, respectable ancêtre des druides qui parcourent aujourd'hui ces bois.</p><p>Avec elle, je peux maintenant me présenter devant le Grand Druide, et exiger qu’il partage le Rituel. Pas pour en violer le secret, mais pour l’accomplir. Pour aider le Royaume. Pour aider Galdric.</p>",
            'position' => 27,
            'last' => false,
            'quest' => 'quest_main',
