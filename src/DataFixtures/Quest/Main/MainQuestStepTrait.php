...
trait MainQuestStepTrait
{
    const MAIN_QUEST_STEPS = [
        ...
        [
            'description' => "<p>J’ai insisté pour obtenir des réponses de Wilbert. Je voulais comprendre dans quoi je mettais les pieds… et pourquoi le Royaume entier semblait marcher sur une poudrière. Le vieux mage a d’abord haussé les épaules, ironique, puis il a croisé mon regard et son sourire s’est éteint. Je lui ai tendu le médaillon trouvé sur le faux Djinn. Son expression a changé. Il a soupiré, et murmuré que ce bijou n’était pas qu’un bijou. C’était le Médaillon des Vents. Un des deux fragments du Sceau.</p><p>Il s’est tu un long moment, puis a parlé d’un trio&nbsp;: lui-même, Gart le Forgeron, et Robert le garde. Un trio qui avait servi Galdric II à l’époque. Il a répété plusieurs fois que ces souvenirs étaient dangereux. Et que je ferais mieux d’aller voir les deux autres, s’ils acceptaient de me parler.</p>",
            'position' => 8,
            'last' => false,
            'quest' => 'quest_main',
        ...
        [
            'description' => "<p>J’ai pris le chemin de la forge de Gart, le vieux forgeron de la cour, qu’on disait proche de la Couronne, surtout à l'époque de Galdric II. Je lui ai montré le médaillon. Il l’a pris, l’a regardé sous tous les angles, a pincé les lèvres… puis l’a reposé sur l’enclume sans un mot. Il a refusé de m'expliquer. Pas un mot sur le Sceau, ni sur le Donjon, ni sur Galdric III et le Prince Alaric. Rien. Mais dans sa colère froide, j’ai perçu quelque chose. Pas du mépris. De la peur.</p><p>Il a laissé échapper une phrase. Un nom&nbsp;:&nbsp;Robert. Ancien garde d’élite, autrefois compagnon du roi, aujourd'hui simple garde sans grade. L’un des trois membres du &laquo;&nbsp;Trio Royal&nbsp;&raquo;&nbsp;:&nbsp;Wilbert le mage, Gart le forgeron… et Robert, la lame fidèle.</p><p>Gart a refusé d’en dire plus. Mais cette piste, elle est là, nette comme une entaille fraîche&nbsp;:&nbsp;si je veux comprendre ce que j’ai entre les mains, je dois aller parler à Robert.</p>",
            'position' => 9,
            'last' => false,
            'quest' => 'quest_main',
        ...
        [
            'description' => "<p>J’ai retrouvé Robert dans le Quartier du Marché. Il m’a fixé comme s’il m’attendait. Pas hostile, juste… prudent. Il m’a fallu insister pour qu’il ouvre la bouche. Il a fini par dire que le Roi Galdric III avait disparu pour retrouver son fils Alaric, et que tout tournait autour d’un vieux mythe&nbsp;:&nbsp;le Donjon de l’Âme.</p><p>Il a craché, puis a parlé du Maire&nbsp;:&nbsp;<em>&laquo;&nbsp;Ce gros rat se pavane avec un médaillon prétendument offert par Galdric II. Mon cul, ouais. C’est sûrement une copie.&nbsp;&raquo;</em></p><p>Avant de s’éloigner, il a ajouté à voix basse que si je voulais vraiment comprendre, il faudrait peut-être jeter un œil aux notes que le Roi rédigeait dans ses appartements. Je dois dire au Maire que j'ai l'autorisation de Robert pour entrer au Palais. Puis il m’a tourné le dos. Robert ne veut pas s’impliquer. Pas encore. Mais il surveille. Et il agira pour son Roi, le moment venu.</p>",
            'position' => 10,
            'last' => false,
            'quest' => 'quest_main',
