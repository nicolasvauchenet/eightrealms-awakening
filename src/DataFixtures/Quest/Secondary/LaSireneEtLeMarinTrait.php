...
trait LaSireneEtLeMarinTrait
{
    const LA_SIRENE_ET_LE_MARIN_QUEST_STEPS = [
        ...
        [
            'description' => "<p>En chantant la ballade près du port, une créature est apparue depuis les flots : une Sirène mélancolique. Elle s'est mise à chanter, et m’a attaqué sans prévenir.</p>",
            'position' => 2,
            'last' => false,
            'quest' => 'quest_secondary_la_sirene_et_le_marin',
            'giver' => 'creature_sirene_melancolique',
            'giverClass' => Creature::class,
            'reference' => 'quest_secondary_la_sirene_et_le_marin_step_2',
        ],
        [
            'description' => "<p>Après un rude combat, elle m’a parlé d’un objet précieux perdu sur une plage lointaine, dans le Désert des Sables Chauds.</p><p>Je dois retrouver cette plage mystérieuse.</p>",
            'position' => 3,
            'last' => false,
            'quest' => 'quest_secondary_la_sirene_et_le_marin',
            'giver' => 'creature_sirene_melancolique',
        ...
        [
            'description' => "<p>J’ai retrouvé la Sirène et lui ai raconté ce que j’ai découvert sur Eryl. Je lui ai montré le journal du traître. Elle était bouleversée, mais elle m’a remercié pour la vérité. Avant de disparaître à jamais dans les flots, elle m’a offert l'amulette&nbsp;:&nbsp;le Cœur d’Écume, en gage d’amitié, et m’a demandé de porter ses regrets à Myra.</p><p>Il est temps de retourner à la Taverne.</p>",
            'position' => 5,
            'last' => false,
            'quest' => 'quest_secondary_la_sirene_et_le_marin',
        ...
        [
            ...
            'giver' => 'npc_myra_la_vieille',
            'giverClass' => Npc::class,
            'reference' => 'quest_secondary_la_sirene_et_le_marin_step_8',
        ],
    ];
}
