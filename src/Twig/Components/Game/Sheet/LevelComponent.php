...
#[AsLiveComponent('PlayerLevel', template: 'game/character/sheet/level/_component/_index.html.twig')]
class LevelComponent extends AbstractController
{
            ...
            switch($characteristic) {
                ...
                case 'constitution':
                    if($this->constitution === $this->character->getConstitution()) {
                        ...
                        $this->health = $this->health + $this->characterBonusService->getCharacterBonus($this->character, 'health')['amount'];
                        $this->characteristicBonus++;
                    }
                    break;
                case 'wisdom':
                ...
                case 'intelligence':
                    if($this->intelligence === $this->character->getIntelligence()) {
                        ...
                        $this->mana = $this->mana + $this->characterBonusService->getCharacterBonus($this->character, 'mana')['amount'];
                        $this->characteristicBonus++;
                    }
                    break;
                case 'charisma':
    ...
    public function validateLevel(): RedirectResponse
    {
        ...
        return $this->redirectToRoute('app_game_character_sheet_player');
    }
}
